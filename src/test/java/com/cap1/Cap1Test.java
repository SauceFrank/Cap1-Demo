...
//                // Windows
    ...
    public void Cap1PageTitle(String type, String browser, String version, String os, String device, Method method) throws Exception {

        WebDriver driver = createDriver(type, browser, version, os, device, method.getName());
        driver.get("https://www.capitalone.com/");
        assertEquals(driver.getTitle(), "Capital One Credit Cards, Bank, and Loans - Personal and Business");
    }
    @Test(dataProvider = "hardCodedBrowsers")
    public void Cap1Func(String type, String browser, String version, String os, String device, Method method) throws Exception {

        WebDriver driver = createDriver(type, browser, version, os, device, method.getName());
        driver.get("https://www.capitalone.com/credit-cards/");
        assertEquals(driver.getTitle(), "Explore Credit Cards & Apply Online | Capital One");
        driver.get("https://www.capitalone.com/bank/");
        assertEquals(driver.getTitle(), "Checking & Savings - Bank Accounts | Capital One");
        driver.get("https://www.capitalone.com/auto-financing/");
        assertEquals(driver.getTitle(), "Auto Financing");
        driver.get("https://www.capitalone.com/learn-grow/");
        assertEquals(driver.getTitle(), "Learn & Grow | Capital One");
    }
